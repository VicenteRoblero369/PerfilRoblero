...
namespace PerfilRoblero.AccesoDatos.Migrations
{
    /// <inheritdoc />
    public partial class DatosActualizer : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Textos = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Chat", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Chat_AspNetUsers_UsuarioAplicacionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chat_UsuarioAplicacionId",
                table: "Chat",
